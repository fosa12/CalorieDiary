using CalorieDiary.Application;
...
using CalorieDiary.Infrastructure.Repositories;
...
namespace CalorieDiary.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                IConfigurationSection googleAuthNSerction = Configuration.GetSection("Authentication:Google");
                options.ClientId = googleAuthNSerction["ClientId"];
                options.ClientSecret = googleAuthNSerction["ClientSecret"];
            });
